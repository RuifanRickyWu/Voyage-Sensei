...
information_retrieval_client = InformationRetrievalClient(llm_agent, config.get('ir').get('prompt'))
...
ir_service = InformationRetrievalService(information_retrieval_client)
