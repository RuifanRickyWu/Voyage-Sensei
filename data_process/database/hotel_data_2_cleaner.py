...
json_dir = os.path.join(current_dir, 'CarTravel/data_process/database/hotel_data_new')
...
print("num_removed: " + str(num_removed))
print("num_have_description: " + str(num_have_des))


'''
All data have description and at least one review.
123/278 hotels don't have price, 155/278 have price (in dollar signs).
'''